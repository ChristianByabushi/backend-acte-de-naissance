...
class accountModel extends Model
{
	...
	{
		$query = "SELECT oauth_users.first_name as firstname, oauth_users.last_name as lastname, oauth_users.username as id, oauth_users.email as email from oauth_users
